            ...
            <div className="flex items-center justify-center gap-2.5 flex-wrap">
              ...
              {normalizeWhatsapp(settings.whatsapp_number) && (
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={handleClose}
                  className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg border border-[#25D366]/40 bg-[#25D366]/10 text-xs font-medium text-[#25D366] hover:bg-[#25D366]/20 transition-colors"
                >
