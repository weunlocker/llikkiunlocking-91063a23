...
export default function AIChatWidget() {
  ...
  return (
    <>
      ...
      {/* Panel */}
      {open && (
        <div className="fixed inset-0 sm:inset-auto sm:right-4 sm:bottom-4 z-50 w-auto sm:w-[380px] h-[100dvh] sm:h-auto sm:max-h-[80vh] flex flex-col rounded-none sm:rounded-2xl border-0 sm:border border-border/60 bg-background/95 backdrop-blur-xl shadow-2xl overflow-hidden">
