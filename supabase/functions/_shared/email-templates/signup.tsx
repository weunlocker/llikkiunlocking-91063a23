...
export const SignupEmail = ({ siteName, siteUrl, recipient, confirmationUrl }: SignupEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Confirm your email to start unlocking with {siteName}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            Thanks for signing up for <Link href={siteUrl} style={link}><strong>{siteName}</strong></Link>.
            Confirm <strong>{recipient}</strong> to activate your account and start unlocking devices.
          </Text>
